...
<body class="novel_body">
    ...
    <div class="container">
        ...
        <div class="text-center mt-2">
            <button id="Next_chat" class="btn btn-info">看下一章</button>
        </div>
    </div>
        ...
        function showNovel(data) {
			...
			if(obj.result == "取得小說成功"){
				obj.novel_data.forEach(novel_chat => {
                    var novel_html = '<div class="col-12 fs-2 text-center chat_name"><a href="' + novel_chat.chat_url + '">' + novel_chat.chat_name + '</a></div><div class="col-12 text-center chat_txt fs-3">' + novel_chat.chat_txt + '</div>';
